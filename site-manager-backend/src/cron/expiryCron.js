...
const checkExpiriesAndSendEmail = async () => {
  ...
  try {
    ...
    if (expired.length > 0 || expiringSoon.length > 0) {
      ...
      return { success: true, expiredCount: expired.length, expiringSoonCount: expiringSoon.length };
    } else {
      console.log("✔ No expiries found today");
      return { success: true, expiredCount: 0, expiringSoonCount: 0 };
    }
  } catch (error) {
...
module.exports = { startExpiryCron, checkExpiriesAndSendEmail };
